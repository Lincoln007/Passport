...
--
  CREATE TABLE "ACCOUNT" 
   (	"ID" NUMBER(*,0) NOT NULL ENABLE,
	...
	"DELETED" NUMBER(*,0) DEFAULT 0     NOT NULL ENABLE,
	"ROLE" NUMBER(*,0) NOT NULL ENABLE,
	"TRUENAME" VARCHAR2(32 CHAR),
	"STATUS" NUMBER(*,0) DEFAULT 0     NOT NULL ENABLE,
	"GROUPS" VARCHAR2(128),
	"DEPARTMENT_ID" NUMBER(*,0) DEFAULT 0     NOT NULL ENABLE,
	"PHONE" VARCHAR2(32 CHAR),
	"JOB" VARCHAR2(64 CHAR),
	"EMAIL" VARCHAR2(128 CHAR),
	"RANK_ID" NUMBER(*,0) DEFAULT 0   NOT NULL ENABLE
...
--
  CREATE TABLE "ACCOUNT_AGENT" 
   (	"ID" NUMBER(*,0) NOT NULL ENABLE,
	...
	"AGENT_ID" NUMBER(*,0) NOT NULL ENABLE,
	"CREATE_TIME" DATE DEFAULT sysdate
    NOT NULL ENABLE,
	"DELETED" NUMBER(*,0) NOT NULL ENABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 NOCOMPRESS LOGGING
  STORAGE( INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  FREELISTS 1 FREELIST GROUPS 1);
--
...
--
  CREATE TABLE "DEPARTMENT" 
   (	"ID" NUMBER(*,0) DEFAULT 0     NOT NULL ENABLE,
	...
	"PARENT_ID" NUMBER(*,0) DEFAULT 0     NOT NULL ENABLE,
	"CREATE_TIME" DATE NOT NULL ENABLE,
	"DELETED" NUMBER(*,0) DEFAULT 0     NOT NULL ENABLE
   ) PCTFREE 10 PCTUSED 40 INITRANS 1 NOCOMPRESS LOGGING
  STORAGE( INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
...
-- PK_RANK_ID
--
ALTER TABLE "RANK" ADD CONSTRAINT "PK_RANK_ID" PRIMARY KEY ("ID") ENABLE;
...
-- RANK_TRIGGER1
--
  CREATE OR REPLACE TRIGGER "RANK_TRIGGER1"
